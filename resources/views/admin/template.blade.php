                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="pcoded-navigation-label">Sistema</div>
                             ...
                             {{-- Galeria Multimidia --}}
                             <ul class="pcoded-item pcoded-left-item">
                                <li class="@if(isset($menu) && in_array($menu, ['imagens', 'videos'])) active @endif pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-video-camera"></i><b>Gal</b></span>
                                        <span class="pcoded-mtext">Galeria</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class="@if(isset($menu) && $menu == 'imagens') active @endif">
                                            <a href="{{route('admin.imagens.listar')}}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Imagens</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class="@if(isset($menu) && $menu == 'videos') active @endif">
                                            <a href="{{route('admin.videos.listar')}}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Vídeos</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
